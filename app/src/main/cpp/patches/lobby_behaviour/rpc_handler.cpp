            ...
            MethodInfo * method)
    {
        switch (auto call_id = (patches::lobby_behaviour::rpc_types) MMLACCAPBPM) {
            case patches::lobby_behaviour::rpc_types::SetCode: {
                ...
                auto translation_controller = app::DestroyableSingleton_1_TranslationController__get_Instance(nullptr);
                auto translated_string = app::TranslationController_GetString_2(
                        translation_controller,
                        app::StringNames__Enum::RoomCode,
                        app::Array_Empty(nullptr),
                        nullptr);
                ...
                auto game_start_manager = app::DestroyableSingleton_1_GameStartManager__get_Instance(nullptr);
